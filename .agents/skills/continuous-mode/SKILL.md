...
- Go back to step 1. Re-orient. The codebase has changed — reassess.

## Rules

- The vision is the compass. Every action moves the codebase toward VISION.md.
- Improve what exists before adding new things. If existing code is messy, refactor it before building on top of it.
